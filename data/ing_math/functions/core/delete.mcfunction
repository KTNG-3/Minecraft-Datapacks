...
scoreboard objectives remove ing_Math.Sqrt_Out
...
scoreboard objectives remove ing_Math.Percent_Hell
scoreboard objectives remove ing_Math.Percent_HellX
scoreboard objectives remove ing_Math.Percent_X10
scoreboard objectives remove ing_Math.Percent_Percent

scoreboard objectives remove ing_Math.Static_Number