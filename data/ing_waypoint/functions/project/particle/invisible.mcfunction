...
execute as @e[tag=ing_waypoint.Private_LoadTarget] at @s if score @a[tag=ing_waypoint.Private_LoadPlayer,limit=1] ing_WP.Settings_Invisible matches 1 run particle dust 1 0 0.5 1 ~ ~1 ~ 0.05 0.75 0.05 10 275 force @a[distance=..100,tag=ing_waypoint.Private_LoadPlayer,limit=1]
