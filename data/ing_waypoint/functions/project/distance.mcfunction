...
execute as @s at @s run scoreboard players operation @s ing_Math.PTG_A = @s ing_WP.Distance_x
...
execute as @s at @s run scoreboard players operation @s ing_Math.PTG_B = @s ing_WP.Distance_z
...
execute as @s at @s if score @s ing_Math.PTG_C matches ..-1 run scoreboard players operation @s ing_Math.PTG_C *= @s ing_MATH.Static_Number
execute as @s at @s run scoreboard players operation @s ing_Math.PTG_A = @s ing_Math.PTG_C
...
execute as @s at @s run scoreboard players operation @s ing_Math.PTG_B = @s ing_WP.Distance_y
...
execute as @s at @s store result score @s ing_WP.Distance run scoreboard players get @s ing_Math.PTG_C