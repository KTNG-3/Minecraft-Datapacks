...
execute as @s if score @s ing_WP.LoadPlayer_Empty matches 1..7 run function ing_waypoint:project/script/player/trigger/slot_empty
execute as @s if score @s ing_WP.LoadPlayer_Empty matches 8.. run function ing_waypoint:project/script/player/trigger/slot_empty_lot
