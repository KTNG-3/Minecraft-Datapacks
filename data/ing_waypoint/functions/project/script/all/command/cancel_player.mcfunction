...
execute as @e[type=minecraft:armor_stand,tag=ing_waypoint.Waypoint] if score @s ing_WP.DATA_ID = @a[tag=ing_waypoint.All_LoadPlayer,limit=1] ing_WP.DATA_ID run tag @s add ing_waypoint.All_LoadTarget
