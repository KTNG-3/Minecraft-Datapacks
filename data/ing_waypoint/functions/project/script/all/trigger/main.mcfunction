...
execute as @e[type=minecraft:armor_stand,tag=ing_waypoint.Waypoint] if score @s ing_WP.DATA_Owner matches -1 run function ing_waypoint:project/script/all/trigger/slot_find
