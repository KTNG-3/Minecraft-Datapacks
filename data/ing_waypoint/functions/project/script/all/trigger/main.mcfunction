...
execute as @s if score @s ing_WP.LoadAll_Empty matches 1..7 run function ing_waypoint:project/script/all/trigger/slot_empty
execute as @s if score @s ing_WP.LoadAll_Empty matches 8.. run function ing_waypoint:project/script/all/trigger/slot_empty_lot
