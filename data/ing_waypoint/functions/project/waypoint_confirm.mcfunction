...
execute if score Distance ing_WP.Settings matches 1 as @s if score @s ing_WP.Settings_Distance matches 1 run title @s actionbar [{"text": ""},{"text":"You are far away from [ ","color":"gold","bold":false},{"score":{"name":"@e[tag=ing_waypoint.Target,limit=1]","objective":"ing_WP.DATA_ID"},"color":"red"},{"text": ". ","color": "red","bold": false},{"selector":"@e[tag=ing_waypoint.Target,limit=1]","bold":false},{"text":" ] By [ ","color":"gold","bold":false},{"score":{"name":"@s","objective":"ing_WP.Distance"},"color":"red"},{"text":" blocks","color":"red","bold":false},{"text":" ]","color":"gold","bold":false}]
