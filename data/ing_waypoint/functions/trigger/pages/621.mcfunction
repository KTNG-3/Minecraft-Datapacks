...
tellraw @s {"text" : ""}
execute as @s if score @s ing_WP.DATA_ID matches 0 run tellraw @s [{"text": "/trigger ing.Waypoint set {ID}","color": "#eb9526","bold": true,"clickEvent":{"action":"suggest_command","value":"/trigger ing.Waypoint set "},"hoverEvent":{"action":"show_text","contents":[{"text":"Click: Suggest command","bold":false,"color":"gray"}]}},{"text": " to start navigation","color": "blue","bold": false}]
execute as @s unless score @s ing_WP.DATA_ID matches 0 run tellraw @s [{"text": "Click Me","color": "#eb9526","bold": true,"clickEvent":{"action":"run_command","value":"/trigger ing.Waypoint.Cancel"}},{"text": " to cancel navigation","color": "blue","bold": false}]
tellraw @s {"text" : ""}
