...
execute as @s unless score @s ing_WP.DATA_ID matches 0 run tellraw @s [{"text": "Click Me","color": "#eb9526","bold": true,"clickEvent":{"action":"run_command","value":"/trigger ing.Help set 6210"}},{"text": " to cancel navigation","color": "blue","bold": false}]
tellraw @s {"text" : ""}
