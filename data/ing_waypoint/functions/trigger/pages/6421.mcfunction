...
execute as @e[type=minecraft:armor_stand,tag=ing_waypoint.Waypoint] if score @s ing_WP.DATA_Owner matches -1 run data modify entity @s CustomNameVisible set value 0b
