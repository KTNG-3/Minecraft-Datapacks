...
tellraw @s {"text" : " "}
tellraw @s [{"text": "/trigger ing.Waypoint {ID}","color": "#eb9526","bold": true,"clickEvent":{"action":"suggest_command","value":"/trigger ing.Waypoint set "},"hoverEvent":{"action":"show_text","contents":[{"text":"Click: Suggest command","bold":false,"color":"gray"}]}},{"text": " to change Waypoint visibility","color": "blue","bold": false}]
tellraw @s {"text" : " "}
