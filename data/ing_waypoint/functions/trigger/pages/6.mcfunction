...
tellraw @s {"text" : ""}
execute unless score Player_Enable ing_WP.Settings matches 1 unless score All_Enable ing_WP.Settings matches 1 run tellraw @s {"text" : "   Nothing to see here","color": "blue"}
