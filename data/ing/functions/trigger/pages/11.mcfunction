...
tellraw @s [{"text" : "Ing Project","color": "dark_green","bold": true},{"text": " Info","color": "gold"}]
tellraw @s {"text" : ""}
tellraw @s [{"text" : "------------ Info ------------","color": "dark_aqua"}]
tellraw @s {"text" : ""}
tellraw @s [{"text" : "Version >> ","color":"green","bold": true},{"text": "alpha-2","color": "blue","clickEvent":{"action":"open_url","value":"https://github.com/KTNG-3/Minecraft-Datapacks"},"hoverEvent":{"action":"show_text","contents":[{"text":"Github\n\nClick: Open Website","bold":false,"color":"gray"}]}}]
...
tellraw @s [{"text" : "Youtube >> ","color":"green","bold": true},{"text": "anythInG","color": "blue","clickEvent":{"action":"open_url","value":"https://www.youtube.com/channel/UCQtZL8RRfTBkYxExVWZxhOA"},"hoverEvent":{"action":"show_text","contents":[{"text":"Ing Project Youtube\n\nClick: Open Website","bold":false,"color":"gray"}]}}]
tellraw @s {"text" : ""}
