...
tellraw @s [{"text" : ">> ","color":"green","bold": true},{"text": "Datapacks","color": "blue","clickEvent":{"action":"run_command","value":"/trigger ing.Help set 12"},"hoverEvent":{"action":"show_text","contents":[{"text":"Go To ` Datapacks ` Page","bold":false,"color":"gray"}]}}]
tellraw @s {"text" : " "}
