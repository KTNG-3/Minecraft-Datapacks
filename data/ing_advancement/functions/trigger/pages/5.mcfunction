...
tellraw @s {"text" : ""}
execute if score Enable ing_AVM.Settings matches 0 run tellraw @s [{"text" : "   Nothing to see here","color": "blue"}]
...
tellraw @s {"text" : ""}
tellraw @s[tag=ing.Admin] [{"text" : "----------- Settings -----------","color": "dark_aqua"}]
